...
const handler = () => {
    ...
    assert(
        absoluteValue(positiveEvenNumber),
        positiveEvenNumber,
        "Exercise 25"
    );
    assert(
    ...
    function startsAndEndsWithVowel(word) {
        return startsWithVowel(word) && endsWithVowel(word);
    }
    ...
    // Exercise 50
    // Write a function definition named first that takes in a sequence and returns the first value of that sequence.
    ...
    // Exercise 51
    // Write a function definition named second that takes in a sequence(ARRAY) and returns the second value of that sequence.

    function second(s) {
        return s[1];
    }

    console.log(assert(second("ubuntu"), "b", "Exercise 51"));
    console.log(assert(second([1, 2, 3]), 2, "Exercise 51"));
    console.log(assert(second(["JS", "is", "awesome"]), "is", "Exercise 51"));
    console.log(addToDone("Exercise 51 is correct."));
    ...
    // Exercise 58
    // Write a function definition named firstAndLast that takes in a sequence and returns the first and last value of that sequence as an array
    ...
    assert(
        getAverageItemPrice(shoppingCart),
        2.1420000000000003,
        "Exercise 99"
    );
